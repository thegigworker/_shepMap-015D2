//
//  ViewLifeCycleLoggingController.swift
//  from Stanford Paul Hegarty
...
// NOTE:  To make work, have other classes who might inherit from UIViewController
//        instead inherit ViewLifeCycleLoggingController class

// Also, in other class can OVERRIDE 

class ViewLifeCycleLoggingController: UIViewController
{
    ...
    private func logVCL(_ msg: String) {
        ...
        if instanceCount == nil {
            instanceCount =  ViewLifeCycleLoggingController.bumpInstanceCount(for: className)
        }
        print("\(ViewLifeCycleLoggingController.logPrefix(for: className))(\(instanceCount!)) \(msg)")
    }
