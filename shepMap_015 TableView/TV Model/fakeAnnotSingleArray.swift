...
class fakeAnnotationsSingleArray_class {
    ...
    class func buildSingleTableArray() -> [fakeShepSingleAnnotation] {
        ...
        var mySingleAnnotation = fakeShepSingleAnnotation(myMapItem: MKMapItem(), currentLinkedRoute: MKRoute(), shepDollarValue: 05.0, myGigSource: GigSource.EasyShift, title: "Temp Name 1", subtitle: "this is a 1 subtitle", StreetAddressLine: "1234 Mariposa Ave.", City: "Thompson", routeDrivingDistance: 3.0, ZipCode: "06277")
        tempSingleArray.append(mySingleAnnotation)
        mySingleAnnotation = fakeShepSingleAnnotation(myMapItem: MKMapItem(), currentLinkedRoute: MKRoute(), shepDollarValue: 27.0, myGigSource: GigSource.TaskRabbit, title: "Temp Name 2", subtitle: "this is a 2 subtitle", StreetAddressLine: "1234 Mariposa Ave.", City: "Thompson", routeDrivingDistance: 22.0, ZipCode: "06277")
        tempSingleArray.append(mySingleAnnotation)
       mySingleAnnotation = fakeShepSingleAnnotation(myMapItem: MKMapItem(), currentLinkedRoute: MKRoute(), shepDollarValue: 24.0, myGigSource: GigSource.GigWalk, title: "Temp Name 3", subtitle: "this is a 3 subtitle", StreetAddressLine: "1234 Mariposa Ave.", City: "Webster", routeDrivingDistance: 13.0, ZipCode: "06278")
        tempSingleArray.append(mySingleAnnotation)
        mySingleAnnotation = fakeShepSingleAnnotation(myMapItem: MKMapItem(), currentLinkedRoute: MKRoute(), shepDollarValue: 25.0, myGigSource: GigSource.FieldAgent, title: "Temp Name 4", subtitle: "this is a 4 subtitle", StreetAddressLine: "1234 Mariposa Ave.", City: "Webster", routeDrivingDistance: 24.0, ZipCode: "06278")
        tempSingleArray.append(mySingleAnnotation)
        mySingleAnnotation = fakeShepSingleAnnotation(myMapItem: MKMapItem(), currentLinkedRoute: MKRoute(), shepDollarValue: 3.0, myGigSource: GigSource.GigWalk, title: "Temp Name 5", subtitle: "this is a 5 subtitle", StreetAddressLine: "1234 Mariposa Ave.", City: "Webster", routeDrivingDistance: 25.0, ZipCode: "06278")
        tempSingleArray.append(mySingleAnnotation)
        mySingleAnnotation = fakeShepSingleAnnotation(myMapItem: MKMapItem(), currentLinkedRoute: MKRoute(), shepDollarValue: 22.0, myGigSource: GigSource.EasyShift, title: "Temp Name 6", subtitle: "this is a 6 subtitle", StreetAddressLine: "1234 Mariposa Ave.", City: "Putnam", routeDrivingDistance: 25.0, ZipCode: "06279")
        tempSingleArray.append(mySingleAnnotation)
        mySingleAnnotation = fakeShepSingleAnnotation(myMapItem: MKMapItem(), currentLinkedRoute: MKRoute(), shepDollarValue: 100.0, myGigSource: GigSource.FieldAgent, title: "Temp Name 22", subtitle: "this is a 7 subtitle", StreetAddressLine: "1234 Mariposa Ave.", City: "Putnam", routeDrivingDistance: 36.0, ZipCode: "06280")
        tempSingleArray.append(mySingleAnnotation)
        mySingleAnnotation = fakeShepSingleAnnotation(myMapItem: MKMapItem(), currentLinkedRoute: MKRoute(), shepDollarValue: 20.0, myGigSource: GigSource.Safari, title: "Temp Name 21", subtitle: "this is a 8 subtitle", StreetAddressLine: "1234 Mariposa Ave.", City: "Pomfret", routeDrivingDistance: 09.0, ZipCode: "06281")
        tempSingleArray.append(mySingleAnnotation)
        mySingleAnnotation = fakeShepSingleAnnotation(myMapItem: MKMapItem(), currentLinkedRoute: MKRoute(), shepDollarValue: 21.0, myGigSource: GigSource.TaskRabbit, title: "Temp Name 50", subtitle: "this is a 8 subtitle", StreetAddressLine: "1234 Mariposa Ave.", City: "Killingly", routeDrivingDistance: 06.0, ZipCode: "06276")
        tempSingleArray.append(mySingleAnnotation)
        mySingleAnnotation = fakeShepSingleAnnotation(myMapItem: MKMapItem(), currentLinkedRoute: MKRoute(), shepDollarValue: 31.0, myGigSource: GigSource.FieldAgent, title: "Temp Name 51", subtitle: "this is a 8 subtitle", StreetAddressLine: "1234 Mariposa Ave.", City: "Killingly", routeDrivingDistance: 16.0, ZipCode: "06276")
        tempSingleArray.append(mySingleAnnotation)
